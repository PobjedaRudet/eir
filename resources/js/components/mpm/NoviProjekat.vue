...
.btn-secondary {
  @apply px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 text-zinc-700 dark:text-zinc-300 text-sm font-medium hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors;
}
</style>
